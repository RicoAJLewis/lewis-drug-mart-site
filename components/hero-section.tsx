...
export default function HeroSection() {
  return (
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center bg-gradient-to-br from-white via-primary-50 to-primary-100">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Reveal className="mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-primary-200 shadow-sm">
          ...
          <Reveal>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/contact#refill"
                className="inline-flex items-center gap-2 px-8 py-3 bg-primary-50 border-2 border-primary-200 text-primary-700 font-semibold rounded-lg hover:bg-primary-100 transition-all shadow-sm hover:shadow-md"
